...
const Sidebar = ({ onSettingsClick }) => {
  return (
    <div className="w-[70px] min-w-[70px] max-w-[70px] h-screen bg-gray-800 border-r border-gray-600 flex flex-col justify-between py-4 flex-shrink-0 sticky top-0">
      ...
      <div className="flex flex-col items-center mt-auto">
        <button className="p-2 hover:bg-gray-700 rounded-md" onClick={onSettingsClick}>
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round" className="text-gray-300">
